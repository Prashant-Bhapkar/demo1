...
class Container(Type):
    ...
    def build(self, context: "Directory", *, dockerfile: str | None = "Dockerfile", target: str | None = "", build_args: list[BuildArg] | None = None, secrets: "list[Secret] | None" = None,) -> Self:
    ...
    async def env_variables(self) -> list["EnvVariable"]:
        ...
        return [EnvVariable(Client.from_context(_ctx)._select("loadEnvVariableFromID", [Arg("id", v.id)],)) for v in _ids]
    ...
    async def export(self, path: str, *, platform_variants: "list[Container] | None" = None, forced_compression: ImageLayerCompression | None = None, media_types: ImageMediaTypes | None = ImageMediaTypes.OCIMediaTypes,) -> bool:
    ...
    async def exposed_ports(self) -> list["Port"]:
        ...
        class Response:
            id: PortID
        _ids = await _ctx.execute(list[Response])
        return [Port(Client.from_context(_ctx)._select("loadPortFromID", [Arg("id", v.id)],)) for v in _ids]
    ...
    async def labels(self) -> list["Label"]:
        ...
        class Response:
            id: LabelID
        _ids = await _ctx.execute(list[Response])
        return [Label(Client.from_context(_ctx)._select("loadLabelFromID", [Arg("id", v.id)],)) for v in _ids]
    ...
    def pipeline(self, name: str, *, description: str | None = "", labels: list[PipelineLabel] | None = None,) -> Self:
    ...
    async def sync(self) -> Self:
        ...
        _ctx = Client.from_context(_ctx)._select("loadContainerFromID", [Arg("id", _id)])
        return Container(_ctx)

    def __await__(self):
        return self.sync().__await__()

    def terminal(self, *, cmd: list[str] | None = None, experimental_privileged_nesting: bool | None = False, insecure_root_capabilities: bool | None = False,) -> "Terminal":
    ...
    def with_directory(self, path: str, directory: "Directory", *, exclude: list[str] | None = None, include: list[str] | None = None, owner: str | None = "",) -> Self:
    ...
    def with_exec(self, args: list[str], *, skip_entrypoint: bool | None = False, stdin: str | None = "", redirect_stdout: str | None = "", redirect_stderr: str | None = "", experimental_privileged_nesting: bool | None = False, insecure_root_capabilities: bool | None = False,) -> Self:
    ...
    def with_files(self, path: str, sources: list["File"], *, permissions: int | None = None, owner: str | None = "",) -> Self:
    ...
    def with_mounted_cache(self, path: str, cache: CacheVolume, *, source: "Directory | None" = None, sharing: CacheSharingMode | None = CacheSharingMode.SHARED, owner: str | None = "",) -> Self:
    ...
    def with_mounted_directory(self, path: str, source: "Directory", *, owner: str | None = "",) -> Self:
    ...
    def with_mounted_file(self, path: str, source: "File", *, owner: str | None = "",) -> Self:
    ...
    def with_mounted_secret(self, path: str, source: "Secret", *, owner: str | None = "", mode: int | None = 256,) -> Self:
    ...
    def with_new_file(self, path: str, *, contents: str | None = "", permissions: int | None = 420, owner: str | None = "",) -> Self:
    ...
    def with_unix_socket(self, path: str, source: "Socket", *, owner: str | None = "",) -> Self:
...
class CurrentModule(Type):
    ...
    def workdir(self, path: str, *, exclude: list[str] | None = None, include: list[str] | None = None,) -> "Directory":
...
class Directory(Type):
    ...
    def docker_build(self, *, platform: Platform | None = None, dockerfile: str | None = "Dockerfile", target: str | None = "", build_args: list[BuildArg] | None = None, secrets: "list[Secret] | None" = None,) -> Container:
    ...
    async def export(self, path: str, *, wipe: bool | None = False,) -> bool:
    ...
    async def sync(self) -> Self:
        ...
        _ctx = Client.from_context(_ctx)._select("loadDirectoryFromID", [Arg("id", _id)])
        return Directory(_ctx)

    def __await__(self):
        return self.sync().__await__()

    def with_directory(self, path: str, directory: Self, *, exclude: list[str] | None = None, include: list[str] | None = None,) -> Self:
...
class File(Type):
    ...
    async def export(self, path: str, *, allow_parent_dir_path: bool | None = False,) -> bool:
...
class Function(Type):
    ...
    async def args(self) -> list["FunctionArg"]:
        ...
        class Response:
            id: FunctionArgID
        _ids = await _ctx.execute(list[Response])
        return [FunctionArg(Client.from_context(_ctx)._select("loadFunctionArgFromID", [Arg("id", v.id)],)) for v in _ids]
    ...
    def with_arg(self, name: str, type_def: "TypeDef", *, description: str | None = "", default_value: JSON | None = None,) -> Self:
...
class FunctionCall(Type):
    ...
    async def input_args(self) -> list["FunctionCallArgValue"]:
        ...
        _ids = await _ctx.execute(list[Response])
        return [FunctionCallArgValue(Client.from_context(_ctx)._select("loadFunctionCallArgValueFromID", [Arg("id", v.id)],)) for v in _ids]
...
class GitRef(Type):
    ...
    def tree(self, *, ssh_known_hosts: str | None = None, ssh_auth_socket: "Socket | None" = None,) -> Directory:
...
class InputTypeDef(Type):
    ...
    async def fields(self) -> list[FieldTypeDef]:
        ...
        class Response:
            id: FieldTypeDefID
        _ids = await _ctx.execute(list[Response])
        return [FieldTypeDef(Client.from_context(_ctx)._select("loadFieldTypeDefFromID", [Arg("id", v.id)],)) for v in _ids]
...
class InterfaceTypeDef(Type):
    ...
    async def functions(self) -> list[Function]:
        ...
        class Response:
            id: FunctionID
        _ids = await _ctx.execute(list[Response])
        return [Function(Client.from_context(_ctx)._select("loadFunctionFromID", [Arg("id", v.id)],)) for v in _ids]
...
class Module(Type):
    ...
    async def dependencies(self) -> list["Module"]:
        ...
        class Response:
            id: ModuleID
        _ids = await _ctx.execute(list[Response])
        return [Module(Client.from_context(_ctx)._select("loadModuleFromID", [Arg("id", v.id)],)) for v in _ids]
    ...
    async def dependency_config(self) -> list["ModuleDependency"]:
        ...
        _ids = await _ctx.execute(list[Response])
        return [ModuleDependency(Client.from_context(_ctx)._select("loadModuleDependencyFromID", [Arg("id", v.id)],)) for v in _ids]
    ...
    async def interfaces(self) -> list["TypeDef"]:
        ...
        class Response:
            id: TypeDefID
        _ids = await _ctx.execute(list[Response])
        return [TypeDef(Client.from_context(_ctx)._select("loadTypeDefFromID", [Arg("id", v.id)],)) for v in _ids]
...
class ModuleSource(Type):
    ...
    def resolve_directory_from_caller(self, path: str, *, view_name: str | None = None,) -> Directory:
    ...
    async def views(self) -> list["ModuleSourceView"]:
        ...
        _ids = await _ctx.execute(list[Response])
        return [ModuleSourceView(Client.from_context(_ctx)._select("loadModuleSourceViewFromID", [Arg("id", v.id)],)) for v in _ids]
    ...
    def with_dependencies(self, dependencies: list[ModuleDependency],) -> Self:
...
class Client(Root):
    ...
    def blob(self, digest: str, size: int, media_type: str, uncompressed: str,) -> Directory:
    ...
    def git(self, url: str, *, keep_git_dir: bool | None = False, experimental_service_host: "Service | None" = None, ssh_known_hosts: str | None = "", ssh_auth_socket: "Socket | None" = None,) -> GitRepository:
    ...
    def http(self, url: str, *, experimental_service_host: "Service | None" = None,) -> File:
    ...
    def load_local_module_source_from_id(self, id: LocalModuleSourceID) -> LocalModuleSource:
    ...
    def load_module_dependency_from_id(self, id: ModuleDependencyID) -> ModuleDependency:
    ...
    def load_module_source_view_from_id(self, id: ModuleSourceViewID) -> ModuleSourceView:
    ...
    def module_source(self, ref_string: str, *, stable: bool | None = False,) -> ModuleSource:
    ...
    def pipeline(self, name: str, *, description: str | None = "", labels: list[PipelineLabel] | None = None,) -> "Client":
        """Creates a named sub-pipeline.
    ...
    def secret(self, name: str, *, accessor: str | None = None,) -> "Secret":
...
class TypeDef(Type):
    ...
    def with_field(self, name: str, type_def: Self, *, description: str | None = "",) -> Self:
    ...
    def with_object(self, name: str, *, description: str | None = "",) -> Self:
